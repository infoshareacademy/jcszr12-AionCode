...
namespace Database.Migrations
{
    ...
    [Migration("20240504120720_UserCookBookIdToString")]
    partial class UserCookBookIdToString
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Database.Entities.RecipeDetails", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Category = "null",
                            Description = "1. Filety z kurczaka pokrój na kawałki.\n2. Papryki i cukinię pokrój w paski, a cebulę w kostkę.\n3. W dużym rondlu rozgrzej olej i dodaj cebulę i czosnek. Smaż przez około 2 minutki.\n4. Dodaj kurczaka i smaż, aż będzie zrumieniony.\n5. Dodaj papryki i cukinię. Smaż na średnim ogniu przez około 5 minut.\n6. Dodaj sok z cytryny, curry, sól i pieprz. Mieszaj i smaż jeszcze przez kilka minut.\n7. Podawaj kurczaka z warzywami jako danie główne.",
                            ImagePath = "http://markowo.pl/aioncode/zdj1.jpg",
                            Name = "Sałatka grecka",
                            UserCookBookId = "1"
                        },
                        new
                        {
                            ...
                            AddDate = new DateTime(2024, 4, 28, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            Category = "dania obiadowe",
                            Description = "1. Na patelni podsmaż cebulę i paprykę pokrojoną w paski na oleju.\n2. Dodaj mieloną wieprzowinę i smaż, aż się zrumieni.\n3. Dodaj przyprawy: chili, paprykę słodką, kumin, czosnek w proszku, sól i pieprz.\n4. Podawaj mięso na tortilli, dodając sałatę, pomidory, kawałki awokado i skwarki tortilli.",
                            ImagePath = "http://127.0.0.1:10000/devstoreaccount1/book-files/tacos.jpg",
                            Name = "Tacos",
                            UserCookBookId = "1"
                        },
                        new
                        ...
                        new
                        {
                            ...
                            AddDate = new DateTime(2024, 4, 28, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            Category = "dania obiadowe",
                            Description = "1. W rondlu podsmaż cebulę i czosnek na oleju.\n2. Dodaj pokrojonego kurczaka i smaż, aż się zrumieni.\n3. Dodaj mieszankę curry oraz mleczko kokosowe.\n4. Gotuj na małym ogniu przez około 15 minut.\n5. Podawaj kurczaka curry razem z ugotowanym ryżem.",
                            ImagePath = "http://127.0.0.1:10000/devstoreaccount1/book-files/curry1.jpg",
                        ...
                        new
                        {
                            ...
                            AddDate = new DateTime(2024, 4, 28, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            Category = "sałatki",
                            Description = "1. Pokrój pomidory, ogórka, cebulę i paprykę.\n2. Dodaj pokrojoną sałatę, oliwki oraz ser feta.\n3. Skrop sałatkę oliwą z oliwek.\n4. Dopraw solą, pieprzem i oregano.\n5. Delikatnie wymieszaj składniki.\n6. Podawaj sałatkę z kawałkiem chleba czosnkowego.",
                            ImagePath = "http://127.0.0.1:10000/devstoreaccount1/book-files/salatka.jpg",
                            Name = "Sałatka grecka",
                            UserCookBookId = "1"
                        },
                        new
                        {
                            ...
                            AddDate = new DateTime(2024, 4, 28, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            Category = "desery",
                            Description = "1. W misce wymieszaj mascarpone, cukier i ekstrakt waniliowy. 2. W innym naczyniu wymieszaj espresso z likierem kawowym. 3. Namocz biszkopty w przygotowanym napoju kawowym. 4. Na dnie foremki ułóż warstwę biszkoptów, następnie warstwę kremu mascarpone. 5. Powtórz warstwy biszkoptów i kremu. 6. Posyp kakao na wierzch. 7. Schłódź tiramisu przez kilka godzin przed podaniem.",
                            ImagePath = "http://127.0.0.1:10000/devstoreaccount1/book-files/tiramisu.jpg",
                            Name = "Tiramisu",
                            UserCookBookId = "3"
                        },
                        new
                        {
                            ...
                            AddDate = new DateTime(2024, 4, 28, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            Category = "dania obiadowe",
                            Description = "1. W rondlu ugotuj makaron wg wskazówek na opakowaniu. 2. Na patelni rozgrzej masło i smaż posiekany czosnek. 3. Dodaj pokrojonego kurczaka i smaż aż będzie złocisty. 4. Wlej śmietanę kremówkę, dodaj starty parmezan i dopraw solą oraz pieprzem. 5. Gotuj sos na małym ogniu, aż zgęstnieje. 6. Na talerzu ułóż makaron, polej sosem i posyp natką pietruszki.",
                            ImagePath = "http://127.0.0.1:10000/devstoreaccount1/book-files/null.jpg",
                        ...
                        new
                        {
                            ...
                            AddDate = new DateTime(2024, 4, 28, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            Category = "desery",
                            Description = "1. Przygotuj ciasto naleśnikowe według ulubionego przepisu.\n2. Na rozgrzaną patelnię wlej cienką warstwę ciasta naleśnikowego i smaż z obu stron.\n3. Wyłóż na środek każdego naleśnika ser twarogowy i ulubiony dżem.\n4. Zwijaj naleśniki i podawaj posypane cukrem pudrem.",
                            ImagePath = "http://127.0.0.1:10000/devstoreaccount1/book-files/naleśniki.jpg",
                            Name = "Naleśniki z serem i dżemem",
                            UserCookBookId = "2"
                        },
                        new
                        {
                            ...
                            AddDate = new DateTime(2024, 4, 28, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            Category = "desery",
                            Description = "1. Upiecz biszkoptowy spód ciasta i ostudź.\n2. Ubij śmietanę kremówką z cukrem na sztywno.\n3. Rozłóż ubitą śmietanę na biszkopcie.\n4. Na wierzch ciasta ułóż ulubione owoce, takie jak truskawki, maliny i kiwi.\n5. Schłódź ciasto przed podaniem.",
                            ImagePath = "http://127.0.0.1:10000/devstoreaccount1/book-files/ciasto.jpg",
                            Name = "Ciasto śmietanowe z owocami",
                            UserCookBookId = "1"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            AddDate = new DateTime(2024, 4, 28, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            Category = "dania obiadowe",
                            Description = "1. W garnku gotuj wodę i gotuj makaron według wskazówek na opakowaniu.\n2. Na patelni podsmaż czosnek i chilli na oliwie.\n3. Dodaj krewetki i smaż przez kilka minut.\n4. Do krewetek dodaj śmietanę, sok z cytryny i starty parmezan.\n5. Gotuj na małym ogniu, aż sos zgęstnieje.\n6. Dodaj ugotowany makaron i mieszaj.\n7. Podawaj danie posypane posiekaną natką pietruszki.",
                            ImagePath = "http://127.0.0.1:10000/devstoreaccount1/book-files/pasta.jpg",
                            Name = "Czarny makaron z krewetkami",
                            UserCookBookId = "1"
                        },
                        new
                        {
                            Id = 14,
                            AddDate = new DateTime(2024, 4, 28, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            Category = "śniadaniowe",
                            Description = "1. Na patelni rozgrzej masło i podsmaż cebulę, czosnek i pomidory.\n2. Dodaj jajka i smaż, aż białko się zetnie.\n3. Posyp jajka przyprawami i posiekaną natką pietruszki.\n4. Podawaj jajka na kawałku chleba lub razem z sałatką.",
                            ImagePath = "http://127.0.0.1:10000/devstoreaccount1/book-files/null.jpg",
                            Name = "Jajka po turecku z masłem palonym",
                            UserCookBookId = "1"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            AddDate = new DateTime(2024, 4, 28, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            Category = "śniadaniowe",
                            Description = "1. Pokrój awokado oraz łososia w cienkie plasterki.\n2. Rozgrzej piekarnik i przygotuj dwie kromki chleba do opieczenia.\n3. Na każdą kromkę chleba połóż plasterki avocado i łososia.\n4. Dopraw kanapki solą i pieprzem według własnego uznania.\n5. Podawaj kanapki z ulubionym sosem lub marynatą.",
                            ImagePath = "http://127.0.0.1:10000/devstoreaccount1/book-files/kanapka.jpg",
                            Name = "Kanapka z avocado i łososiem",
                            UserCookBookId = "1"
                        },
                        new
                        {
                            ...
                            AddDate = new DateTime(2024, 4, 28, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            Category = "obiadowe",
                            Description = "1. W rondlu rozgrzej śmietanę.\n2. Dodaj pokrojony w plastry łosoś i dus przez kilka minut.\n3. Dopraw do smaku solą i pieprzem.\n4. Podawaj danie z ulubionymi dodatkami, np. ryżem oraz sałatką.",
                            ImagePath = "http://127.0.0.1:10000/devstoreaccount1/book-files/losos.jpg",
                            Name = "Łosoś w sosie śmietanowym",
                            UserCookBookId = "1"
                        });
                });
